...
function isLeadershipRole(role) {
    return ['admin', 'organizer', 'founder', 'president', 'core_founder', 'co_founder', 'advisor', 'co van', 'co van chuyen mon', 'core', 'vice', 'leader', 'truong ban', 'pho ban'].includes(normalize(role));
}
