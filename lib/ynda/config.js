...
const EXECUTIVE_ROLES = new Set([
  ROLES.FOUNDER, ROLES.PRESIDENT, ROLES.CO_FOUNDER, ROLES.CORE_FOUNDER, ROLES.ADVISOR
]);

const ROLE_ORDER = [
  ROLES.FOUNDER, ROLES.PRESIDENT, ROLES.CO_FOUNDER, ROLES.CORE_FOUNDER,
  ROLES.ADVISOR, ROLES.CORE, ROLES.VICE, ROLES.MEMBER
];
